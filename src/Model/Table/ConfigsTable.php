...
class ConfigsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('temporada')
            ->add('temporada', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->scalar('claveconfig')
            ->requirePresence('claveconfig', 'create')
            ->notEmpty('claveconfig');

        $validator
            ->date('diaactivo')
            ->requirePresence('diaactivo', 'create')
            ->notEmpty('diaactivo');
    ...
    {
        $rules->add($rules->isUnique(['temporada']));
