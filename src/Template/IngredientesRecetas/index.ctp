...
/**
  ...
  * @var \App\Model\Entity\IngredientesReceta[]|\Cake\Collection\CollectionInterface $ingredientesRecetas
  */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $ingredientesReceta->ingrediente_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $ingredientesReceta->ingrediente_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $ingredientesReceta->ingrediente_id], ['confirm' => __('Are you sure you want to delete # {0}?', $ingredientesReceta->ingrediente_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
