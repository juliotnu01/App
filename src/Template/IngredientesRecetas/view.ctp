...
/**
  ...
  * @var \App\Model\Entity\IngredientesReceta $ingredientesReceta
  */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('Edit Ingredientes Receta'), ['action' => 'edit', $ingredientesReceta->ingrediente_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Ingredientes Receta'), ['action' => 'delete', $ingredientesReceta->ingrediente_id], ['confirm' => __('Are you sure you want to delete # {0}?', $ingredientesReceta->ingrediente_id)]) ?> </li>
...
<div class="ingredientesRecetas view large-9 medium-8 columns content">
    <h3><?= h($ingredientesReceta->ingrediente_id) ?></h3>
